(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('cropperjs/dist/cropper.css'), require('cropperjs'), require('mime')) :
  typeof define === 'function' && define.amd ? define(['cropperjs/dist/cropper.css', 'cropperjs', 'mime'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["vue-avatar-cropper"] = factory(null, global.Cropper, global.mime));
})(this, (function (cropper_css, Cropper, mime) { 'use strict';
  ...
  var script = {
    ...
    methods: {
      ...
      onFileChange(file) {
        ...
        this.jsFileName = file.name || 'unknown';
      ...
      getFilename(blob) {
        ...
        // Default logic
        if (!this.filename) {
          let actualFilename = this.jsFileName;

          const filenameParts = this.jsFileName;
        ...
        if (typeof this.filename === 'string') return this.filename
